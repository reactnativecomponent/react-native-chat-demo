...
public class StickerCategory implements Serializable {
    ...
    public StickerCategory(AssetManager assetManager, String name, String title, boolean system, int order) {
        this.title = title;
        this.name = name;
        this.system = system;
        this.order = order;

        loadStickerData(assetManager);
    }
    ...
    public List<StickerItem> loadStickerData(AssetManager assetManager) {
