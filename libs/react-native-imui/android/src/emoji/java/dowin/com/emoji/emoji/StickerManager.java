...
import dowin.com.emoji.file.FileUtil;
...
public class StickerManager {
    ...
    public void init(Context context){
        loadStickerCategory(context.getApplicationContext());
    }
    ...
    private void loadStickerCategory(Context context) {
        ...
        try {
            ...
            for (String name : files) {
                if (!FileUtil.hasExtentsion(name)) {
                    category = new StickerCategory(assetManager,name, name, true, getStickerOrder(name));
