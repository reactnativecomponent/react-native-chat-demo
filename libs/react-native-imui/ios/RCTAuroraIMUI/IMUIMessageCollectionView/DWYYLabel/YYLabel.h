...
typedef void(^YYLabelTapUrlBlock)(NSString *strUrl);
typedef void(^YYLabelTapNumberBlock)(NSString *strNumber);
...
@property (copy, nonatomic) YYLabelTapUrlBlock urLBlock;
@property (copy, nonatomic) YYLabelTapNumberBlock numBlock;
