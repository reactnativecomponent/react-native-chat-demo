 ...
 * @Last Modified time: 2019-03-28 09:45:45
 */
  ...
  static navigationOptions = ({ navigation }) => ({
    ...
    headerLeft: (
      <HeaderButtons color="#037aff">
        <HeaderButtons.Item color="#037aff" title="朋友" onPress={() => navigation.push('FriendList')} />
      </HeaderButtons>
    ),
    headerRight: (
      <HeaderButtons color="#037aff">
        <HeaderButtons.Item color="#037aff" title="创建群聊" onPress={navigation.getParam('handlerCreateTeam')} />
      </HeaderButtons>
    ),
  })
  constructor(props) {
